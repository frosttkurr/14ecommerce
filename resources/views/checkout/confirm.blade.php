    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Konfirmasi</h1>
            <span>Konfirmasi Pesanan Anda</span>
          </div>
        </div>
      </div>
    </div>
         ...
         <div class="col-md-12">
           <div class="contact-form">
               ...
               <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                         <div class="form-group">
                              <input type="text" name="alamat" class="form-control" placeholder="Nama Jalan/Gedung, No. Rumah, Kecamatan, Kelurahan, Kode Pos" value="{{-- old('alamat') --}}">
                         </div>
                    </div>
               </div>
               <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                         <div class="form-group">
                              <input type="text" name="subtotal" hidden class="form-control" value="{{-- $grandtotal --}}" placeholder="Sub Total">
                              <input type="text" name="discount" hidden class="form-control" value="{{-- $totalDisc --}}" placeholder="Potongan">
                              <input type="text" name="weight" hidden class="form-control" value="{{-- $weight --}}" placeholder="Berat">
                         </div>
                    </div>
               </div>
               <div class="row">
    ...
    <div class="contact-information2">
        ...
        <ul class="list-group list-group-flush">
          ...
          <!--<li class="list-group-item">
               <div class="row">
                    ...
                    <div class="col-6 text-right">
                         <strong id="total-bayar">{{-- "Rp" . number_format(($grandtotal - $totalDisc)+$ongkir, 0, ",", ",") --}}</strong>
                    </div>
               </div>
          </li>-->
        </ul>
      ...
      <div div class="col-sm-12 mt-4">
          <div class="d-flex justify-content-center">
               <button type="submit" id="form-submit" class="btn btn-warning">Cek Ongkir & Payment</button>
          </div>
     </div>   
    </div>
</form>
