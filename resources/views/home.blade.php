        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="{{asset('styleuser/mobile/assets/images/product-1-720x480.jpg')}}" alt="">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="{{asset('styleuser/mobile/assets/images/product-2-720x480.jpg')}}" alt="">
              <div class="down-content">
                <h4>Lorem ipsum dolor sit amet</h4>
                <div style="margin-bottom:10px;">
                  <span> <del><sup>$</sup>2000.00</del>  <sup>$</sup>1700.00 </span>
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="{{asset('styleuser/mobile/assets/images/product-3-720x480.jpg')}}" alt="">
              <div class="down-content">
                <h4>Lorem ipsum dolor sit amet</h4>
                <div style="margin-bottom:10px;">
                  <span> <del><sup>$</sup>2000.00</del>  <sup>$</sup>1700.00 </span>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="left-image">
                <img src="{{asset('styleuser/mobile/assets/images/about-1-570x350.jpg')}}" class="img-fluid" alt="">
              </div>
            </div>
        ...
        <div class="row" id="tabs">
          ...
          <div class="col-md-8">
            <section class='tabs-content'>
              <article id='tabs-1'>
                <img src="{{asset('styleuser/mobile/assets/images/blog-image-1-940x460.jpg')}}" alt="">
              ...
              <article id='tabs-2'>
                <img src="{{asset('styleuser/mobile/assets/images/blog-image-2-940x460.jpg')}}" alt="">
                <h4><a href="blog-details.html">Mauris lobortis quam id dictum dignissim</a></h4>
                <p>Sed ut dolor in augue cursus ultrices. Vivamus mauris turpis, auctor vel facilisis in, tincidunt vel diam. Sed vitae scelerisque orci. Nunc non magna orci. Aliquam commodo mauris ante, quis posuere nibh vestibulum sit amet</p>
              </article>
              <article id='tabs-3'>
                <img src="{{asset('styleuser/mobile/assets/images/blog-image-3-940x460.jpg')}}" alt="">
