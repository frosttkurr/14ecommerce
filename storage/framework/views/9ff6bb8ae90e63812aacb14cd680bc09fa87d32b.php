...
<div class="container" style="margin-top:79px";>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-light"><?php echo e(__('Admin Register')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="profile_image" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Profil Image')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="profile_image" value="<?php echo e(old('profile_image')); ?>" required autocomplete="profile_image" autofocus>
...
<?php echo $__env->make('admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\pratikumPrognet\resources\views/admin-register.blade.php ENDPATH**/ ?>