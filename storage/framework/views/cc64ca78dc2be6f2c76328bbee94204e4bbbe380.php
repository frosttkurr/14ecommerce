...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('styleuser/mobile/assets/css/fontawesome.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('styleuser/mobile/assets/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('styleuser/mobile/assets/css/owl.css')); ?>">
  </head>
  ...
  <body>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="<?php echo e(asset('styleuser/mobile/assets/images/product-1-720x480.jpg')); ?>" alt="">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="<?php echo e(asset('styleuser/mobile/assets/images/product-2-720x480.jpg')); ?>" alt="">
              <div class="down-content">
                <h4>Lorem ipsum dolor sit amet</h4>
                <div style="margin-bottom:10px;">
                  <span> <del><sup>$</sup>2000.00</del>  <sup>$</sup>1700.00 </span>
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="<?php echo e(asset('styleuser/mobile/assets/images/product-3-720x480.jpg')); ?>" alt="">
              <div class="down-content">
                <h4>Lorem ipsum dolor sit amet</h4>
                <div style="margin-bottom:10px;">
                  <span> <del><sup>$</sup>2000.00</del>  <sup>$</sup>1700.00 </span>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="left-image">
                <img src="<?php echo e(asset('styleuser/mobile/assets/images/about-1-570x350.jpg')); ?>" class="img-fluid" alt="">
              </div>
            </div>
        ...
        <div class="row" id="tabs">
          ...
          <div class="col-md-8">
            <section class='tabs-content'>
              <article id='tabs-1'>
                <img src="<?php echo e(asset('styleuser/mobile/assets/images/blog-image-1-940x460.jpg')); ?>" alt="">
              ...
              <article id='tabs-2'>
                <img src="<?php echo e(asset('styleuser/mobile/assets/images/blog-image-2-940x460.jpg')); ?>" alt="">
                <h4><a href="blog-details.html">Mauris lobortis quam id dictum dignissim</a></h4>
                <p>Sed ut dolor in augue cursus ultrices. Vivamus mauris turpis, auctor vel facilisis in, tincidunt vel diam. Sed vitae scelerisque orci. Nunc non magna orci. Aliquam commodo mauris ante, quis posuere nibh vestibulum sit amet</p>
              </article>
              <article id='tabs-3'>
                <img src="<?php echo e(asset('styleuser/mobile/assets/images/blog-image-3-940x460.jpg')); ?>" alt="">
    ...
    <script src="<?php echo e(asset('styleuser/mobile/vendor/jquery/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('styleuser/mobile/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>

    <!-- Additional Scripts -->
    <script src="<?php echo e(asset('styleuser/mobile/assets/js/custom.js')); ?>"></script>
    <script src="<?php echo e(asset('styleuser/mobile/assets/js/owl.js')); ?>"></script>
    <script src="<?php echo e(asset('styleuser/mobile/assets/js/slick.js')); ?>"></script>
    <script src="<?php echo e(asset('styleuser/mobile/assets/js/accordions.js')); ?>"></script>
...
</html><?php /**PATH C:\xamp\htdocs\pratikumPrognet\resources\views/home.blade.php ENDPATH**/ ?>