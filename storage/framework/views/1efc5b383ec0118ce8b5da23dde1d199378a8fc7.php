...
<?php $__env->startSection('page-contents'); ?>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                       ...
                       <?php else: ?>
                          ...
                          <td>
                            <img src="<?php echo e(asset('product_images/'.$i->image_name)); ?>" style="width:260px;" alt="">
            ...
            <div class="col-md-12">
                      ...
                      <tbody>
                       ...
                       <?php else: ?>
                        ...
                        <tr>
                          ...
                          <td class="td-actions text-left" >
                            <a href="<?php echo e(route('response.add_response',$review)); ?>"  rel="tooltip" title="Review Product" class="btn btn-primary btn-link btn-sm">
              ...
              <div class="card">
                ...
                <li class="d-none d-lg-block"> <a href="<?php echo e(route('discount.add',['id'=>$product->id])); ?>" class="btn btn-primary header-btn"><i class="material-icons">add</i>Add Discount</a>
                    </li>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                      ...
                      <tbody>   
                        <?php $__currentLoopData = $discount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <td class="td-actions text-left">
                                ...
                                <a href="<?php echo e(route('discount.edit',$item->id)); ?>"  rel="tooltip" title="Review Product" class="btn btn-primary btn-link btn-sm">
