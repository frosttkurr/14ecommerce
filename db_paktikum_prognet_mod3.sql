...
insert  into `carts`(`id`,`user_id`,`product_id`,`qty`,`created_at`,`updated_at`,`status`) values (6,15,3,1,NULL,NULL,'notyet');
insert  into `carts`(`id`,`user_id`,`product_id`,`qty`,`created_at`,`updated_at`,`status`) values (7,15,1,1,NULL,NULL,'notyet');
...
insert  into `couriers`(`id`,`courier`,`created_at`,`updated_at`) values (3,'JNT','2021-03-17 09:16:31','2021-03-17 09:16:47');
...
insert  into `discounts`(`id`,`id_product`,`percentage`,`start`,`end`,`created_at`,`updated_at`) values (1,1,20,'2021-04-03','2021-04-05','2021-04-03 14:45:42','2021-04-03 14:45:42');
...
insert  into `products`(`id`,`product_name`,`price`,`description`,`product_rate`,`created_at`,`updated_at`,`stock`,`weight`) values (1,'Redmi Note 9 Pro',3000000,'Redmi Note 9 Pro dilengkapi dengan kamera quad level flagship. Kamera utama 64MP dengan jelas mengabadikan momen favoritmu dan lensa sudut ultra lebar, lensa makro, dan sensor kedalaman, akan memastikan kamu untuk mendapatkan hasil terbaik dari momen yang ingin kamu abadikan.',4,'2021-03-24 13:46:08','2021-03-24 13:46:08',10,1);
insert  into `products`(`id`,`product_name`,`price`,`description`,`product_rate`,`created_at`,`updated_at`,`stock`,`weight`) values (2,'Poco X3 Pro',3500000,'POCO adalah semua yang Anda butuhkan, tidak ada yang tidak Anda butuhkan.',3,'2021-03-25 12:55:52','2021-03-25 12:55:52',23,1);
insert  into `products`(`id`,`product_name`,`price`,`description`,`product_rate`,`created_at`,`updated_at`,`stock`,`weight`) values (3,'iPhone 12 Pro MAX',24000000,'Sistem kamera Pro yang menghadirkan fotografi pencahayaan rendah ke tingkat lebih tinggi — bahkan dengan peningkatan yang signifikan di iPhone 12 Pro Max. ',4,'2021-03-27 23:04:25','2021-03-27 23:04:25',5,1);
...
insert  into `users`(`id`,`name`,`email`,`profile_image`,`status`,`email_verified_at`,`password`,`remember_token`,`created_at`,`updated_at`) values (15,'cobadulu','cobadulu@gmail.com','IMG_8788.JPG','Sudah Terdaftar','2021-03-24 12:19:52','$2y$10$Jt./odmpBgLorwC9AOh8Iu58bXEdbUqdZyDwApNlZwQgWRWFa8HIm',NULL,'2021-03-24 12:17:53','2021-03-24 12:19:52');
